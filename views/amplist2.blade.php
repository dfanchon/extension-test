...
<html ⚡>
  <head>
    <meta charset="utf-8">
    <link rel="canonical" href="<%host%>/samples_templates/news_article/">
    <!-- #### Setup -->
    <!--
  ...
  <body>
      ...
      <a class="card related" href=/detail?id=[[ $article['diffbotUri'] ]]>
        <amp-img width="101" height="75" src="[[ $article['images'][0]['url'] ]]"></amp-img>
